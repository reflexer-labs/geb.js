...
export class AuctionedSurplusSetter extends BaseContractAPI {
    ...
    minAuctionedSurplus(): Promise<BigNumber>
    minAuctionedSurplus(multicall: true): MulticallRequest<BigNumber>
    minAuctionedSurplus(
        multicall?: true
    ): Promise<BigNumber> | MulticallRequest<BigNumber> {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"minAuctionedSurplus","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}
    ...
    recomputeSurplusAmountAuctioned(feeReceiver: string): TransactionRequest {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[{"internalType":"address","name":"feeReceiver","type":"address"}],"name":"recomputeSurplusAmountAuctioned","outputs":[],"stateMutability":"nonpayable","type":"function"}
    ...
    targetValue(): Promise<BigNumber>
    targetValue(multicall: true): MulticallRequest<BigNumber>
    targetValue(
        multicall?: true
    ): Promise<BigNumber> | MulticallRequest<BigNumber> {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"targetValue","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}
