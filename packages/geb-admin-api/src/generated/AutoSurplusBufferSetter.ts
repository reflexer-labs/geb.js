...
export class AutoSurplusBufferSetter extends BaseContractAPI {
    ...
    adjustSurplusBuffer(feeReceiver: string): TransactionRequest {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[{"internalType":"address","name":"feeReceiver","type":"address"}],"name":"adjustSurplusBuffer","outputs":[],"stateMutability":"nonpayable","type":"function"}
    ...
    coveredDebt(): Promise<BigNumber>
    coveredDebt(multicall: true): MulticallRequest<BigNumber>
    coveredDebt(
        multicall?: true
    ): Promise<BigNumber> | MulticallRequest<BigNumber> {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"coveredDebt","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}
    ...
    getNewBuffer(currentGlobalDebt: BigNumberish): Promise<BigNumber>
    getNewBuffer(
        currentGlobalDebt: BigNumberish,
        multicall: true
    ): MulticallRequest<BigNumber>
    getNewBuffer(
        currentGlobalDebt: BigNumberish,
        ...
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[{"internalType":"uint256","name":"currentGlobalDebt","type":"uint256"}],"name":"getNewBuffer","outputs":[{"internalType":"uint256","name":"newBuffer","type":"uint256"}],"stateMutability":"view","type":"function"}

        return this.ethCallOrMulticall(abi, [currentGlobalDebt], multicall)
    }
    ...
    percentageDebtChange(currentGlobalDebt: BigNumberish): Promise<BigNumber>
    ...
    percentageDebtChange(
        ...
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[{"internalType":"uint256","name":"currentGlobalDebt","type":"uint256"}],"name":"percentageDebtChange","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}
