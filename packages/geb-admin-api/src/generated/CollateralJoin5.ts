...
export class CollateralJoin5 extends BaseContractAPI {
    ...
    collateral(multicall?: true): Promise<string> | MulticallRequest<string> {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"collateral","outputs":[{"internalType":"contract CollateralLike5","name":"","type":"address"}],"stateMutability":"view","type":"function"}
