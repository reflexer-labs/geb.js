...
export class GebSafeManager extends BaseContractAPI {
    allowHandler(usr: string, ok: BigNumberish): Promise<TransactionRequest> {
        ...
        return this.ethSend(abi, [usr, ok])
    }
    ...
    allowSAFE(
        ...
        return this.ethSend(abi, [safe, usr, ok])
    }
    ...
    enterSystem(src: string, safe: BigNumberish): Promise<TransactionRequest> {
        ...
        return this.ethSend(abi, [src, safe])
    }
    ...
    modifySAFECollateralization(
        ...
        return this.ethSend(abi, [safe, deltaCollateral, deltaDebt])
    }
    ...
    moveSAFE(
        ...
        return this.ethSend(abi, [safeSrc, safeDst])
    }
    ...
    openSAFE(
        ...
        return this.ethSend(abi, [collateralType, usr])
    }
    ...
    protectSAFE(
        ...
        return this.ethSend(abi, [safe, liquidationEngine, saviour])
    }
    ...
    quitSystem(safe: BigNumberish, dst: string): Promise<TransactionRequest> {
        ...
        return this.ethSend(abi, [safe, dst])
    }
    ...
    transferCollateral(
        ...
        return this.ethSend(abi, [safe, dst, wad])
    }
    ...
    transferInternalCoins(
        ...
        return this.ethSend(abi, [safe, dst, rad])
    }
