...
export class GebProxyActions<TX_OBJ> extends BaseContractAPI<TX_OBJ> {
    allowHandler(
        ...
        return this.chainProvider.ethSend(this.address, abi, [manager, usr, ok])
    }
    ...
    approveSAFEModification(obj: string, usr: string): Promise<TX_OBJ> {
        // prettier-ignore
        // @ts-ignore
        ...
        return this.chainProvider.ethSend(this.address, abi, [obj, usr])
    }
    ...
    denySAFEModification(obj: string, usr: string): Promise<TX_OBJ> {
        // prettier-ignore
        // @ts-ignore
    ...
    ethJoin_join(apt: string, safe: string): Promise<TX_OBJ> {
        // prettier-ignore
        // @ts-ignore
        ...
        return this.chainProvider.ethSend(this.address, abi, [apt, safe])
    }
    ...
    makeCollateralBag(collateralJoin: string): Promise<TX_OBJ> {
        // prettier-ignore
        // @ts-ignore
        ...
        return this.chainProvider.ethSend(this.address, abi, [collateralJoin])
    }
