...
export class Coin extends BaseContractAPI implements ERC20 {
    ...
    approve(usr: string, amount: BigNumberish): Promise<TransactionRequest> {
        // prettier-ignore
        // @ts-ignore
        ...
        return this.ethSend(abi, [usr, amount])
    }
    ...
    burn(usr: string, amount: BigNumberish): Promise<TransactionRequest> {
        // prettier-ignore
        // @ts-ignore
    ...
    mint(usr: string, amount: BigNumberish): Promise<TransactionRequest> {
        // prettier-ignore
        // @ts-ignore
    ...
    move(
        ...
        return this.ethSend(abi, [src, dst, amount])
    }
    ...
    pull(usr: string, amount: BigNumberish): Promise<TransactionRequest> {
        // prettier-ignore
        // @ts-ignore
    ...
    push(usr: string, amount: BigNumberish): Promise<TransactionRequest> {
        // prettier-ignore
        // @ts-ignore
    ...
    transfer(dst: string, amount: BigNumberish): Promise<TransactionRequest> {
        // prettier-ignore
        // @ts-ignore
        ...
        return this.ethSend(abi, [dst, amount])
    }
